...
def allpay_100518752(amount: int | None = None):
    """
    ...
    MCH_ID = "100518752"
    SECRET_KEY = "9cb9d8c2c7dd45269924a698d9e06bca"
    ...
    NOTIFY_URL = "https://winzo777.bet/api/notify/allpay"
    PAGE_URL = "https://winzo777.bet/payment/complete"
    PAY_TYPE = "104"
    GOODS_NAME = "topup"
    ...
    order_id = f"TXN{int(time.time())}{int(time.time() * 1000) % 1000:03d}"
...
if __name__ == "__main__":
    print(allpay_100518752(amount=100))