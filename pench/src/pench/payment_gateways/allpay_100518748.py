...
def allpay_100518748(amount: int | None = None):
    """
    ...
    MCH_ID = "100518748"  # From documentation example
    SECRET_KEY = "2d813aead499491b9836235f7252d134"  # Replace with actual key from merchant backend
    ...
    NOTIFY_URL = "https://tiger365.club/api/payment/callback"
    PAGE_URL = "https://tiger365.club/payment/redirect"
    PAY_TYPE = "104"  # Consult merchant backend for channel coding
    GOODS_NAME = "deposit"
    MCH_RETURN_MSG = "payment"

    HTTP_TIMEOUT_GATEWAY = float(os.getenv("HTTP_TIMEOUT_GATEWAY", "20"))

    # Generate unique order ID with timestamp
    order_id = f"PAY{int(time.time())}{random.randint(100, 999)}"
...
if __name__ == "__main__":
    print(allpay_100518748(amount=100))
